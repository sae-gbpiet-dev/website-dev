...
function PageHeader({ title }: PageHeaderProps) {
  return (
    <div className="page-header-reveal flex w-full items-center justify-center gap-3 px-4 sm:gap-6 sm:px-6 lg:gap-12 lg:px-8">
      <div className="page-header-line page-header-line-left lg:h-10 h-6 flex-1 border-t-[6px] border-b-[6px] border-brand-blue sm:h-12 sm:border-t-8 sm:border-b-8"></div>
      ...
      <div className="page-header-line page-header-line-right lg:h-10 h-6 flex-1 border-t-[6px] border-b-[6px] border-brand-gold sm:h-12 sm:border-t-8 sm:border-b-8"></div>
    </div>
  );
}
